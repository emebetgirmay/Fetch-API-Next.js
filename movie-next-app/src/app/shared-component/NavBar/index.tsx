    ...
    <div className="bg-gray-950 w-full text-white">
      <nav className="flex items-center justify-between px-6 sm:px-12 lg:px-16 py-5 z-50 relative">
        ...
        <div className="flex items-center text-3xl font-extrabold">
          ...
          />
          M<span className="text-orange-500">oo</span>vie
        </div>
        ...
        <div className="hidden lg:flex items-center gap-8">
          <div className="relative">
            <button
              ...
              className="text-lg font-medium text-gray-300 hover:text-pink-300 transition-colors"
            >
              More
            </button>
            {isDropdownOpen && (
              <div className="absolute top-10 left-0 bg-gray-800 rounded-lg shadow-lg w-40 py-2 z-10">
                <Link
                  href="/genres"
                  className="block px-4 py-2 text-gray-300 hover:bg-pink-300 hover:text-white transition-colors"
                ...
                <Link
                  href="/contact"
                  className="block px-4 py-2 text-gray-300 hover:bg-pink-300 hover:text-white "
                  onClick={() => setIsDropdownOpen(false)}
                >
                  Contact
                </Link>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-gray-900 px-6 py-4 flex flex-col gap-4">
          ...
          <div className="relative">
            <button
              onClick={toggleDropdown}
              className="text-lg font-medium text-gray-300 hover:text-pink-300 "
            >
              More
            </button>
            {isDropdownOpen && (
              <div className="bg-gray-800 rounded-lg shadow-lg w-full py-2 mt-2">
                <Link
                  href="/genres"
                  className="block px-4 py-2 text-gray-300 hover:text-pink-300 hover:text-white "
                  onClick={() => {
