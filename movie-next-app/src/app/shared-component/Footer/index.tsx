      ...
      <footer className="flex flex-wrap justify-between px-6 sm:px-12 lg:px-16 py-12 gap-8">
        <div className="min-w-[200px]">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              onClick={() => {}}
              variant="outlined"
              classname="flex items-center gap-3 bg-gray-800 text-white px-4 py-3 rounded-full text-sm hover:text-pink-300 "
            >
        ...
        <div className="min-w-[150px]">
          ...
          <ul className="space-y-2 text-gray-300">
            <li className="hover:text-pink-300 transition-colors cursor-pointer">Home</li>
            <li className="hover:text-pink-300 transition-colors cursor-pointer">My List</li>
            <li className="hover:text-pink-300 transition-colors cursor-pointer">About Us</li>
          </ul>
        </div>
        ...
        <div className="min-w-[150px]">
          ...
          <ul className="space-y-2 text-gray-300">
            <li className="hover:text-pink-300 transition-colors cursor-pointer">General Info</li>
            <li className="hover:text-pink-300 transition-colors cursor-pointer">Privacy Policy</li>
            <li className="hover:text-pink-300 transition-colors cursor-pointer">Terms of Service</li>
          </ul>
        </div>
        ...
        <div className="min-w-[200px]">
          ...
          <div className="flex gap-4 mt-4">
            <a href="#" className="p-2 bg-gray-800 rounded-full hover:bg-pink-300 transition-colors">
